...
// Define the Domain component
export const Domain = () => (
  <>
    {/* Mirrored from kanakku.dreamstechnologies.com/html/template/domain.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Apr 2024 05:57:24 GMT */}
    <meta charSet="utf-8" />
              ...
              <ul className="list-inline-item list-unstyled links">
                ...
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="domain.html" className="active">
                        Domain
                      </a>
                    </li>
                    <li>
                    ...
                    <table className="table table-stripped table-hover datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Basic <span className="plane-type"> (Yearly)</span>
                          </td>
                          <td>19 Jan 2024</td>
                          <td>
                            <span className="badge bg-orange-light d-inline-flex align-items-center">
